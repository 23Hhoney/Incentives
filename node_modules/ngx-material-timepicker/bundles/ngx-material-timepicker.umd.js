    ...
    ***************************************************************************** */
    ...
    var TimeAdapter = /** @class */ (function () {
        ...
        TimeAdapter.formatTime = function (time, opts) {
            ...
            if (format !== 24) {
                return parsedTime.toLocaleString(__assign({}, luxon.DateTime.TIME_SIMPLE, { hour12: format !== 24, numberingSystem: TimeAdapter.DEFAULT_NUMBERING_SYSTEM })).replace(/\u200E/g, '').replace(/\u202F/g, ' ');
            }
        ...
        TimeAdapter.toLocaleTimeString = function (time, opts) {
            ...
            var localOpts = __assign({ locale: opts.locale, numberingSystem: opts.numberingSystem }, timeFormat);
    ...
    var NUMBERING_SYSTEM = new core.InjectionToken('NumberingSystem', {
        providedIn: 'root',
    ...
    var NgxMaterialTimepickerContainerComponent = /** @class */ (function () {
        ...
        NgxMaterialTimepickerContainerComponent.prototype.ngOnInit = function () {
            this.animationState = !this.disableAnimation && exports.ɵt.ENTER;
            this.defineTime();
        ...
        NgxMaterialTimepickerContainerComponent.prototype.close = function () {
            ...
            this.animationState = exports.ɵt.LEAVE;
        };
        NgxMaterialTimepickerContainerComponent.prototype.animationDone = function (event) {
            if (event.phaseName === 'done' && event.toState === exports.ɵt.LEAVE) {
                this.timepickerBaseRef.close();
            }
        };
    ...
    var TimeParserPipe = /** @class */ (function () {
        ...
        TimeParserPipe.ctorParameters = function () { return [
            { type: String, decorators: [{ type: core.Inject, args: [TIME_LOCALE,] }] },
            { type: String, decorators: [{ type: core.Inject, args: [NUMBERING_SYSTEM,] }] }
        ]; };
        TimeParserPipe = __decorate([
            ...
            core.Injectable(),
            __param(0, core.Inject(TIME_LOCALE)), __param(1, core.Inject(NUMBERING_SYSTEM))
        ], TimeParserPipe);
    ...
    exports.ɵf = NUMBERING_SYSTEM;
    exports.ɵg = NgxMaterialTimepickerHoursFace;
    exports.ɵh = TimeParserPipe;
    exports.ɵi = NgxMaterialTimepickerButtonComponent;
    exports.ɵj = NgxMaterialTimepickerPeriodComponent;
    exports.ɵk = TimeFormatterPipe;
    exports.ɵl = OverlayDirective;
    exports.ɵm = AutofocusDirective;
    exports.ɵn = MinutesFormatterPipe;
    exports.ɵo = NgxTimepickerTimeControlComponent;
    exports.ɵp = NgxTimepickerPeriodSelectorComponent;
    exports.ɵq = TimeLocalizerPipe;
    exports.ɵr = ActiveHourPipe;
    exports.ɵs = ActiveMinutePipe;
    exports.ɵu = NgxMaterialTimepickerContainerComponent;
    exports.ɵv = NgxMaterialTimepickerContentComponent;
    exports.ɵw = AppendToInputDirective;
