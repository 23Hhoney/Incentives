...
export class NotificationsService
{
    ...
    constructor(private _httpClient: HttpClient,private httpClient:HttpService)
    {
    }
    ...
    getNotificationList(id, request) {
        return this.httpClient.post('api/Notifications/GetNotificationsPaginated/'+id, request)
      }
}
