...
export class SearchMockApi
{
    ...
    registerHandlers(): void
    {
            ...
            // if (!modules) {
            // console.error('Modules not found in sessionStorage');
            // } else {
            // console.log(this._defaultNavigation);

            // if (this._defaultNavigation && this._defaultNavigation[0] && this._defaultNavigation[0].children) {
            // const newNavigationArray = this._defaultNavigation[0].children.filter((item) => {
            // if (!item || !item.moduleKey) return false;

            // // Handle cases where moduleKey is a comma-separated string
            // const moduleKeys = item.moduleKey.split(',');
            // return moduleKeys.some(moduleKey => modules.includes(moduleKey.trim()));
            // });

            // this._defaultNavigation[0].children = newNavigationArray;
            // } else {
            // console.error('Default navigation is not properly initialized');
            // }
        ...
        // // const newNavigationArray = this._defaultNavigation[0].children.filter((item) => {
        // //     if (!item || !item.moduleKey) return false; 
        // //     return modules.find(module => module === item.moduleKey);
        // // });
        // // this._defaultNavigation[0].children = newNavigationArray;
